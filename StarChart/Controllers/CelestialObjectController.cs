...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        public  IActionResult Update(int id, CelestialObject newCelestialObject)
        {
            ...
            if (currentCelestialObject == null) return NotFound();
            currentCelestialObject.Name = newCelestialObject.Name;
            currentCelestialObject.OrbitalPeriod = newCelestialObject.OrbitalPeriod;
            currentCelestialObject.OrbitedObjectId = newCelestialObject.OrbitedObjectId;
